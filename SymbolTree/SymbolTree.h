...
public:
    ...
    void addSymbolEntry(string variableName, string variableType, string value = "0", bool isInitialised = false, bool isConstant = false);
    ...
    bool checkFunctionReturnType(string value);
    ~SymbolTree();
};